		...
		init : function(ed, url) {
			...
			ed.addCommand('mceElvtImage', function() {
				ed.windowManager.open({
					file : url + '/index1.php?d=../../../../../public/uploads/',
					//file : url + '/dialog.htm',
...
function openmanager(field_name, url, type, win) {    
    ...
    var strUploaderURL = strPluginPath + "/index1.php";												// generate the path to the uploader script
    var strUploadPath = "../../../../../public/uploads/";					// get the relative upload path
