...
// Default: $_CONFIG['hidden_files'] = array(".ftpquota", "index1.php", "index1.php~", ".htaccess", ".htpasswd");
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index1.php", "index1.php~", ".htaccess", ".htpasswd", "encodeexplorer.php");
...
// See fail peaks asuma serveris aadressil [AADRESS]/index1.php
